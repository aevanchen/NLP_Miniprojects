...
class model(nn.Module):
    ...
    def forward(self, input_seq):
        ...
        #preivously, the relu layber is put before the linear is correct, normally we should put it after the linear layer.
        #Yet, we delte the relu layber because we already have a softmax activation in the crossentropy loss fucntion thus relu is not needed anymore
